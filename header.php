	...
	<div class="top-nav hidden md:block astro-3EF6KSR2">
		<div class="social-icon flex p-1 h-7 astro-3EF6KSR2">
			...
			<p class="flex pr-20 astro-3EF6KSR2">
				...
				<a class="px-3 astro-3EF6KSR2" style="width:45px" href="https://www.facebook.com/kvks.sel/"><img src="<?php echo get_template_directory_uri()?>/src/image/icons/facebook.png" alt="facebook" class="astro-3EF6KSR2"></a>
				<a class="px-3 astro-3EF6KSR2" style="width:45px" href="https://www.instagram.com/kvkualaselangor_official/"><img src="<?php echo get_template_directory_uri()?>/src/image/icons/instagram.png" alt="instagram" class="astro-3EF6KSR2"></a>
				<a class="px-3 astro-3EF6KSR2" style="width:43px" href="https://www.google.com/maps/dir/2.9229056,101.6929667/google+maps+kv+kuala+selangor/@3.1457593,101.3959934,11z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x31cc60db623bb93d:0x3c9391707e336109!2m2!1d101.3981924!2d3.3831747?entry=ttu"><img src="<?php echo get_template_directory_uri()?>/src/image/icons/google-maps.png" alt="googlemaps" class="astro-3EF6KSR2"></a>
			</p>
		</div>
